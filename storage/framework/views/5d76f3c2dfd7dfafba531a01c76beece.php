        ...
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                <div class="flex justify-center mb-4">
                    <img src="/images/mbstu-logo.png" alt="MBSTU Logo" class="h-16 w-16 object-contain">
                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary-600 hover:text-primary-800">
                            Forgot password?
                        </a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-primary-600 hover:text-primary-800 font-medium">Register here</a>
                    </p>
                </div>
...
<?php /**PATH /home/kawshik/Desktop/Project/alumni-system/resources/views/auth/login.blade.php ENDPATH**/ ?>