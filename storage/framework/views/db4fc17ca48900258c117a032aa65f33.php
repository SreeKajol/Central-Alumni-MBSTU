...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 rounded-lg shadow-lg p-6 text-white">
        ...
        <p class="text-primary-100"><?php echo e(auth()->user()->role->label()); ?></p>
    </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($stats['total_departments']); ?></p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($stats['total_alumni']); ?></p>
                </div>
                <svg class="w-12 h-12 text-primary-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($stats['upcoming_events']); ?></p>
                </div>
                <svg class="w-12 h-12 text-primary-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($stats['total_news']); ?></p>
                </div>
                <svg class="w-12 h-12 text-primary-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('news.index')); ?>" class="text-primary-600 hover:text-primary-800 text-sm font-medium">View All</a>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start space-x-3 pb-4 border-b last:border-b-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <a href="<?php echo e(route('news.show', $news)); ?>" class="text-sm font-medium text-gray-900 hover:text-primary-600">
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="text-primary-600 hover:text-primary-800 text-sm font-medium">View All</a>
            </div>
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start space-x-3 pb-4 border-b last:border-b-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <a href="<?php echo e(route('events.show', $event)); ?>" class="text-sm font-medium text-gray-900 hover:text-primary-600">
                                <?php echo e($event->title); ?>

                            </a>
                            <p class="text-xs text-gray-500 mt-1"><?php echo e($event->event_date->format('M d, Y')); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if(auth()->user()->isAlumni() && !auth()->user()->alumniProfile): ?>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-700">
                        ...
                        <a href="<?php echo e(route('alumni.create')); ?>" class="font-medium underline hover:text-yellow-600">Create your profile now</a> to connect with other alumni!
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kawshik/Desktop/Project/Central Alumni MBSTU/resources/views/dashboard.blade.php ENDPATH**/ ?>