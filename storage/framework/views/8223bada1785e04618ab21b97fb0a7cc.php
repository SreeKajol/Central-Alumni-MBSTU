    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            ...
            <?php if(auth()->check() && auth()->user()->alumniProfile): ?>
                <a href="<?php echo e(route('recommendations.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('recommendations.*') ? 'active' : ''); ?>">
                    <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('analytics.career')); ?>" class="sidebar-link <?php echo e(request()->routeIs('analytics.*') ? 'active' : ''); ?>">
                <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
