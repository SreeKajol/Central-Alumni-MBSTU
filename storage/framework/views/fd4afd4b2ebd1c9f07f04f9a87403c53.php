                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(url('/')); ?>" class="flex items-center space-x-3 group">
                            <div class="relative">
                                ...
                                <img src="/images/mbstu-logo.png" alt="MBSTU Logo" class="relative h-12 w-12 object-contain transition-transform group-hover:scale-110 duration-300">
                            </div>
                            <div>
                                <span class="text-xl font-bold text-primary-600 block leading-tight">Central Alumni</span>
                                <span class="text-xs text-gray-600 font-medium">MBSTU</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition shadow-md hover:shadow-lg">
            ...
            <div class="max-w-6xl mx-auto px-4 text-center">
                ...
                <div class="flex justify-center items-center gap-8 flex-wrap">
                    <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition">
                        <img src="/images/mbstu-logo.png" alt="MBSTU" class="h-12 w-12 object-contain mx-auto">
        ...
        <footer class="bg-white py-8 border-t">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col items-center space-y-4">
                    <div class="flex items-center space-x-3">
                        <img src="/images/mbstu-logo.png" alt="MBSTU Logo" class="h-12 w-12 object-contain">
...
<?php /**PATH /home/kawshik/Desktop/Project/alumni-system/resources/views/alumni/archive.blade.php ENDPATH**/ ?>