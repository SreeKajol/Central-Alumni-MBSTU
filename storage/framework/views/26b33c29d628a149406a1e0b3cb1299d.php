<?php $__env->startSection('title', 'Career Analytics Dashboard'); ?>
<?php $__env->startSection('header', 'Career Analytics Dashboard'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <form method="GET" action="<?php echo e(route('analytics.career')); ?>" class="flex gap-3 items-center">
                        <select name="department_id" class="form-select rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors" onchange="this.form.submit()">
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dept->id); ?>" <?php echo e($selectedDepartment == $dept->id ? 'selected' : ''); ?>>
            ...
            <?php if(empty($localStats['totalAlumni'])): ?>
            ...
            <?php else: ?>
                    ...
                    <div class="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-xl shadow-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-4xl font-bold mt-2 drop-shadow-md"><?php echo e($localStats['totalAlumni'] ?? 0); ?></p>
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-emerald-500 via-green-600 to-emerald-700 rounded-xl shadow-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-4xl font-bold mt-2 drop-shadow-md"><?php echo e($localStats['verifiedAlumni'] ?? 0); ?></p>
                            </div>
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-3">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-700 rounded-xl shadow-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-4xl font-bold mt-2 drop-shadow-md"><?php echo e($localStats['employedAlumni'] ?? 0); ?></p>
                                <p class="text-sm text-white mt-1 opacity-90"><?php echo e($localStats['totalAlumni'] > 0 ? round(($localStats['employedAlumni'] / $localStats['totalAlumni']) * 100, 1) : 0); ?>% rate</p>
                            </div>
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-3">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-gradient-to-br from-orange-500 via-amber-600 to-orange-700 rounded-xl shadow-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-4xl font-bold mt-2 drop-shadow-md"><?php echo e(count($localStats['industryBreakdown'] ?? [])); ?></p>
                            </div>
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-3">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-gradient-to-br from-pink-500 via-rose-600 to-pink-700 rounded-xl shadow-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-4xl font-bold mt-2 drop-shadow-md"><?php echo e($localStats['publicProfiles'] ?? 0); ?></p>
                            </div>
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-3">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                ...
                <?php if(!empty($localStats['industryBreakdown']) && count($localStats['industryBreakdown']) > 0): ?>
                    <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $localStats['industryBreakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-1">
                                        <span class="text-sm font-medium text-gray-700"><?php echo e($industry); ?></span>
                                        <span class="text-sm text-gray-600 font-semibold"><?php echo e($count); ?> (<?php echo e(round($percentage, 1)); ?>%)</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                        <div class="<?php echo e($color); ?> h-3 rounded-full transition-all duration-700 shadow-sm" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <!-- Top Companies -->
                <?php if(!empty($localStats['topCompanies']) && count($localStats['topCompanies']) > 0): ?>
                    <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-100">
                        <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            <?php $__currentLoopData = $localStats['topCompanies']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg hover:shadow-lg hover:border-green-300 transition-all duration-300">
                                    <span class="font-semibold text-gray-800 text-sm"><?php echo e($company); ?></span>
                ...
                <!-- Top Positions -->
                <?php if(!empty($localStats['topPositions']) && count($localStats['topPositions']) > 0): ?>
                    <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-100">
                        <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <?php $__currentLoopData = $localStats['topPositions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg hover:shadow-lg hover:border-purple-300 transition-all duration-300">
                                    <span class="font-medium text-gray-700 text-sm"><?php echo e($position); ?></span>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <?php if(!empty($localStats['graduationDistribution']) && count($localStats['graduationDistribution']) > 0): ?>
                        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
                            ...
                            <div class="overflow-x-auto">
                                <div class="flex items-end justify-center space-x-3 h-64 pb-6 px-2">
                                    <?php $__currentLoopData = $localStats['graduationDistribution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="flex flex-col items-center" style="min-width: 60px;">
                                            <div class="text-sm font-bold text-gray-800 mb-2"><?php echo e($count); ?></div>
                                            <div class="w-full bg-gradient-to-t from-indigo-600 via-blue-500 to-blue-400 rounded-t-lg transition-all duration-500 hover:from-indigo-700 hover:via-blue-600 hover:to-blue-500 shadow-lg" style="height: <?php echo e($actualHeight); ?>px; min-height: 20px;"></div>
                                            <div class="text-xs text-gray-700 mt-3 font-semibold"><?php echo e($year); ?></div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                    ...
                    <!-- City Distribution -->
                    <?php if(!empty($localStats['cityDistribution']) && count($localStats['cityDistribution']) > 0): ?>
                        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
                            <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                            ...
                            <div class="space-y-2">
                                <?php $__currentLoopData = $localStats['cityDistribution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg hover:shadow-md transition-all duration-300">
                                        <span class="text-sm font-medium text-gray-700"><?php echo e($city); ?></span>
                ...
                <?php if(!empty($localStats['countryDistribution']) && count($localStats['countryDistribution']) > 0): ?>
                    <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-100">
                        <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                            <svg class="w-6 h-6 mr-3 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            <?php $__currentLoopData = $localStats['countryDistribution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-center p-5 bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 rounded-xl border-2 border-indigo-200 hover:shadow-lg hover:border-indigo-400 transition-all duration-300">
                                    <div class="text-4xl font-extrabold text-indigo-600"><?php echo e($count); ?></div>
                                    <div class="text-sm text-gray-800 mt-2 font-bold"><?php echo e($country); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kawshik/Desktop/Project/Central Alumni MBSTU/resources/views/recommendations/analytics.blade.php ENDPATH**/ ?>