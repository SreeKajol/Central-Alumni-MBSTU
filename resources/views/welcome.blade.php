...
<head>
    ...
    <title>{{ config('app.name', 'Central Alumni MBSTU') }}</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="{{ route('alumni.index') }}" class="nav-link px-4 py-2 rounded-lg text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition font-medium">
                            <svg class="w-5 h-5 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            Alumni
                        </a>
                        <a href="{{ route('departments.index') }}" class="nav-link px-4 py-2 rounded-lg text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition font-medium">
                            <svg class="w-5 h-5 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                            Departments
                        </a>
                        <a href="{{ route('events.index') }}" class="nav-link px-4 py-2 rounded-lg text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition font-medium">
                            <svg class="w-5 h-5 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                            Events
                        </a>
                        <a href="{{ route('news.index') }}" class="nav-link px-4 py-2 rounded-lg text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition font-medium">
                            <svg class="w-5 h-5 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-3">
                        @auth
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-black rounded-lg font-bold hover:from-primary-700 hover:to-primary-800 transition shadow-lg hover:shadow-xl ring-2 ring-primary-200 hover:ring-primary-300">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="px-4 py-2.5 text-gray-700 hover:text-primary-600 font-semibold transition">
                                Login
                            </a>
                            <a href="{{ route('register') }}" class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition shadow-md hover:shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('alumni.index') }}" class="btn btn-primary px-8 py-3 text-lg">
                        Browse Alumni Directory
                    </a>
                    <a href="{{ route('departments.index') }}" class="btn btn-secondary px-8 py-3 text-lg">
                        Explore Departments
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a href="{{ route('departments.index') }}" class="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition text-center">
                        <div class="text-2xl mb-2">🏛️</div>
                        <div class="font-medium text-gray-900">Departments</div>
                    </a>
                    <a href="{{ route('alumni.index') }}" class="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition text-center">
                        <div class="text-2xl mb-2">👥</div>
                        <div class="font-medium text-gray-900">Alumni</div>
                    </a>
                    <a href="{{ route('events.index') }}" class="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition text-center">
                        <div class="text-2xl mb-2">📅</div>
                        <div class="font-medium text-gray-900">Events</div>
                    </a>
                    <a href="{{ route('news.index') }}" class="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition text-center">
                        <div class="text-2xl mb-2">📰</div>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-6 p-6 lg:p-8">
                        ...
                        <!-- CTA Button -->
                        <div class="pt-4">
                            <a href="{{ route('alumni.archive') }}" class="inline-flex items-center bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-700 transition shadow-lg hover:shadow-xl">
                                Alumni Archive
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-4">
                            <a href="{{ route('alumni.archive') }}" class="block group overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition">
...
<<<<<<< HEAD
                ...
                <div class="text-center mt-12">
                    <a href="{{ route('alumni.index') }}" class="inline-flex items-center px-8 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        View All Alumni
...
>>>>>>> 78ebf9cf692714fb93a2894277478235eb635f49
        ...
        <section class="bg-primary-600 text-white py-16">
            <div class="max-w-5xl mx-auto text-center px-4">
                ...
                <a href="{{ route('register') }}" class="bg-white text-primary-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition inline-block ml-4">
                    Join the Network
                </a>
            </div>
        </section>
        ...
        <footer class="bg-white mt-16 py-8 border-t">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col items-center space-y-4">
                    ...
                    <p class="text-gray-600 text-sm">&copy; {{ date('Y') }} Central Alumni MBSTU. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
