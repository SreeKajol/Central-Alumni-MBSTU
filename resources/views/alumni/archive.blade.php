...
<head>
    ...
    <title>Alumni Photo Archive - {{ config('app.name', 'Central Alumni MBSTU') }}</title>
    ...
    <div class="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex items-center space-x-3">
                        @auth
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-lg font-bold hover:from-primary-700 hover:to-primary-800 transition shadow-lg hover:shadow-xl ring-2 ring-primary-200 hover:ring-primary-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-md p-6">
                <form method="GET" action="{{ route('alumni.archive') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <div>
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search photos..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    </div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('alumni.archive') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition">
                            Clear
                        </a>
                    </div>
                </form>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
                    ...
                    @foreach($photos as $photo)
                        <div class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white transform hover:-translate-y-1 flex flex-col">
                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                <h3 class="font-bold text-xl text-gray-900 mb-3 line-clamp-1">{{ $photo->title }}</h3>
                                ...
                                @if($photo->event_name)
                                    <div class="flex items-center text-sm text-primary-600 font-medium mb-3 px-1">
                                        ...
                                        <span class="line-clamp-1">{{ $photo->event_name }}</span>
                                    </div>
                                @endif

                                @if($photo->description)
                                    <p class="text-sm text-gray-600 mb-4 line-clamp-2 leading-relaxed px-1">{{ $photo->description }}</p>
                                @endif
            ...
            @else
                ...
                <div class="text-center py-16 bg-white rounded-lg shadow-md">
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}" class="mt-6 inline-flex items-center px-6 py-3 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700 transition">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
